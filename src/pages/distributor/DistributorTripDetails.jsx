// src/pages/distributor/DistributorTripDetails.jsx
...
const DistributorTripDetails = () => {
    ...
    const handleCancelTrip = async () => {
        ...
        try {
            const result = await tripService.cancelTrip(id, "Cancelled by distributor admin");
            if (result.success) {
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        <Button
                            variant="outline"
                            size="sm"
                            onClick={() => navigate("/distributor/trips")}
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        {(trip.status === "Started" || trip.status === "InProgress") && (
                            <Button
                                size="sm"
                                onClick={() => navigate(`/distributor/trips/${trip.id}/track`)}
                                className="flex items-center gap-2"
                            >
...
export default DistributorTripDetails;
