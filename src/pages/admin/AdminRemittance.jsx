...
const AdminRemittance = () => {
    ...
    const getSelectedTotal = () => {
        if (!selectedDispatcher) return 0;
        return selectedDispatcher.payments
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4">
                            <div className="flex items-center gap-3 mb-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-gray-600 dark:text-gray-400">
                                        {selectedDispatcher.payments.length} payment(s) to confirm
                                    </p>
                                </div>
                            </div>
                            <div className="flex justify-between text-sm">
                                ...
                                <span className="font-bold text-lg text-gray-900 dark:text-white">
                                    {formatCurrency(selectedDispatcher.totalAmount)}
                                </span>
                            </div>
                        </div>
                        ...
                        <div>
                                    ...
                                    onClick={() =>
                                        setSelectedPayments(
                                            selectedPayments.length ===
                                                selectedDispatcher.payments.length
                                                ? []
                                                : selectedDispatcher.payments.map((p) => p.id)
                                        )
                                    }
                                >
                                    {selectedPayments.length ===
                            ...
                            <div className="max-h-60 overflow-y-auto border border-gray-200 dark:border-gray-700 rounded-lg">
                                {selectedDispatcher.payments.map((payment) => (
                                    <div
                                        key={payment.id}
