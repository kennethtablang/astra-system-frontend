...
const AdminWarehouses = () => {
    ...
    const fetchWarehouses = async () => {
        try {
            setLoading(true);
            // Admin sees all warehouses (no distributorId filter)
    ...
    const filteredWarehouses = warehouses.filter((warehouse) =>
        ...
        warehouse.distributorName?.toLowerCase().includes(searchTerm.toLowerCase())
    );
                ...
                <div className="flex justify-between items-center">
                    <div>
                        ...
                        <p className="text-gray-600 dark:text-gray-400 mt-1">
                            Manage all warehouses across distributors
                        </p>
                    </div>
                            ...
                            <Card key={warehouse.id} className="hover:shadow-lg transition-shadow">
                                <CardContent className="p-5">
                                    ...
                                    <div className="mt-4 space-y-2">
                                        {warehouse.distributorName && (
                                            <div className="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400">
                                                <Package className="h-4 w-4" />
                                                <span>{warehouse.distributorName}</span>
                                            </div>
                                        )}
                                        <div className="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400">
